...
import { _useGlobalVariants } from "./plasmic"; // plasmic-import: 5JFp4hBddqScvsM8xAASW5/projectModule
import { _useStyleTokens } from "./PlasmicStyleTokensProvider"; // plasmic-import: 5JFp4hBddqScvsM8xAASW5/styleTokensProvider

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: 5JFp4hBddqScvsM8xAASW5/projectcss
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: BSUSW5nb0s8d/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: NVW0iA2-XtIw/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: P3mMiRohWj8i/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg___24M1G)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox___44NQ7)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__czAkG)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__b5P6U)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__tS0Bs)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
